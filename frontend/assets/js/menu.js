/**
 * Fonctions pour gérer le menu mobile et les menus déroulants (dropdowns).
 * Permet d’ouvrir, fermer et animer les menus sur les appareils mobiles.
 * A utiliser pour améliorer l’ergonomie de la navigation sur petits écrans.
 */
